...
#  default['powerdns']['server']['edns_subnet_processing'] = false
  ...
  default['powerdns']['server']['tcp_control_port'] = 53_000
...
default['powerdns']['server']['local_address'] = nil
...
default['powerdns']['server']['setgid'] = 'pdns'
default['powerdns']['server']['setuid'] = 'pdns'
...
default['powerdns']['server']['soa_expire_default'] = 604_800
default['powerdns']['server']['soa_minimum_ttl'] = 3600
default['powerdns']['server']['soa_refresh_default'] = 10_800
